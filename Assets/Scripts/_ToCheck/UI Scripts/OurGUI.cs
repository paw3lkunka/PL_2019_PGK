...
// 
public class OurGUI : MonoBehaviour
{
    #region Variables
...
#pragma warning restore
    ...
    private readonly Color32 waterBad = new Color32(108, 130, 255, 255); // ligh  #region MonoBehaviour
    ...
    public void Update()
    {
        CrewIndicator = GameplayManager.Instance.cultistInfos.Count;
